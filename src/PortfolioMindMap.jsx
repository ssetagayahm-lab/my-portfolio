...
それぞれ別のスペシャリスト（電気工事業者、システムインテグレーター、デザイナー）が必要だった領域を、一貫した思想のもとにシームレスに結合できる。` },
  ...
  },
  {
    ...
    photos: [
      ...
      { caption: "案件U - 03", src: "/images/IMG_5297.jpeg" },
    ],
  },
  {
    id: "space",
...
BOSE 55WER × 4（出力）` },
  ...
  {
    id: "app",
    label: "Tiny Party Production",
    en: "タイニーパーティープロダクション",
    code: "TTP.06",
    sub: "Sound and Light Package",
    type: "audio",
    angle: -30,
              ...
              {activeNode.photos[photoIndex].venue ? (
                ...
                <div style={{ display: "flex", flexDirection: "row", width: "100%", height: "100%", gap: 0 }}>
                  ...
                  <div style={{ flex: 1, padding: "14px 12px", display: "flex", flexDirection: "column", gap: 10, overflowY: "auto" }}>
                    ...
                    <a
                      href={activeNode.photos[photoIndex].venue.instagram}
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ fontSize: 8.5, color: "#5a5a5a", textDecoration: "none", letterSpacing: 0.5 }}
                    >
                      Instagram ↗
                    </a>
                    <div style={{ borderTop: `0.5px solid ${RING}`, opacity: 0.3 }} />
                    <div style={{ fontSize: 9, lineHeight: 1.8, color: INK }}>
                      {activeNode.photos[photoIndex].venue.desc}
                    </div>
                  </div>
                </div>
