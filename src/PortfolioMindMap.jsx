...
const NODES = [
  ...
  },
  {
    ...
    en: "TOUCHDESIGNER",
    code: "TD.04",
    sub: "DMX / Audio リアクティブ制御",
    angle: 30,
    accent: ["#8c4a8c", "#c79bc7"],
    photos: [
      { caption: "DMX 制御ネットワーク", src: "/images/touchdesigner-01.jpg" },
      { caption: "オーディオリアクティブ", src: "/images/touchdesigner-02.jpg" },
      { caption: "統合制御 テスト", src: "/images/touchdesigner-03.jpg" },
    ],
  },
  {
    id: "av",
...
export default function PortfolioMindMap() {
  ...
  function nodePos(angle, sz) {
    ...
    const r = radius + (sz ? (sz - MAX_NODE_SIZE) * 2.6 : 0);
